...
public class DownRageAllStrings extends GhidraScript {

	static byte KEY[] = new byte[] { 0x5f, 0x19, 0x36, 0x2c, 0x53, 0x3e, 0x6f, 0x1a, 0x0c, 0x6a, 0x20, 0x2e, 0x34 };
	...
	public void run() throws Exception {
		...
		for (Reference ref : getReferencesTo(deobfuscator.getEntryPoint())) {
			...
			createAsciiString(stringAddr, size);
